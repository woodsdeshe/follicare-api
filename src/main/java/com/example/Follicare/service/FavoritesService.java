...
//    }
//
//    public void addSpecialistToFavorites(Long profileId, Long specialistId) {
//        Optional<Profiles> profileOptional = profileRepository.findById(profileId);
//        Optional<Specialist> specialistOptional = specialistRepository.findById(specialistId);
//
//        if (profileOptional.isPresent() && specialistOptional.isPresent()) {
//            Profiles profile = profileOptional.get();
//            Specialist specialist = specialistOptional.get();
//
//            profile.getFavorites().add(specialist);
//            profileRepository.save(profile);
//        } else {
//            throw new NotFoundException("Profile or Specialist not found");
//        }
//    }
//
//    public void removeSpecialistFromFavorites(Long profileId, Long specialistId) {
//        Optional<Profiles> profileOptional = profileRepository.findById(profileId);
//        Optional<Specialist> specialistOptional = specialistRepository.findById(specialistId);
//
//        if (profileOptional.isPresent() && specialistOptional.isPresent()) {
...
//            Specialist specialist = specialistOptional.get();
//
//            profile.getFavorites().remove(specialist);
//            profileRepository.save(profile);
//        } else {
//            throw new NotFoundException("Profile or Specialist not found");
//        }
